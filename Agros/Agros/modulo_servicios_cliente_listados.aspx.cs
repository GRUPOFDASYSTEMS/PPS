...
namespace Agros
{
    public partial class modulo_servicios_cliente_listados : System.Web.UI.Page
    {
        ...
        {
            lerror.Text = np.generarFactura(Label2.Text, Session["cliente"].ToString());

            if (lerror.Text.Substring(0,5) == "Error")
                lerror.ForeColor = System.Drawing.Color.Red;
            else
                lerror.ForeColor = System.Drawing.Color.Green;

        }



        //public string generarFactura(string id_os) {
        ...
        //        error= np.verificarOperacion(resultado, "UPD")? "Generacion de factura exitosa":"Error: Ha ocurrido un error al intentar generar la factura";
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                estado = linker.obtener_dato(" estados where descripcion='No Aprobada' and tema='orden_servicio' ", 0);
